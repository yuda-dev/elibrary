...
class DashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        $umr = User::get()->sum('umur');

        $totumr = $umr/$jmlumr;
        
        return view('dashboard.index', compact('title','kategori','book','ip','data','books','categories','anggota','hari_ini','bulan_ini','tahun_ini','comment','lk','pr','totumr'));
    }
}
